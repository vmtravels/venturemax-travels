// Create a new file:
// app/classic-hobart-tour/page.js
// Paste the Classic 4-Day Hobart Itinerary content into that page to create a dedicated tour details page.
...
export default function TasmaniaTourPromoPage() {
  ...
  const accommodations = [
    {
      name: "Peaceful Hideaway, Close to Everything",
      image:
        "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?q=80&w=1200&auto=format&fit=crop",
      description:
        "Modern waterfront accommodation with stunning harbour views.",
      link:
        "https://www.airbnb.com.au/rooms/1269156852546849184?adults=1&check_in=2026-09-08&check_out=2026-09-10&guests=2&search_mode=regular_search&source_impression_id=p3_1779776697_P36Ch2UgFJBIGgRW&previous_page_section_name=1000&federated_search_id=ea3e9aaf-3e67-46a4-9e42-4e9723279e8f",
    },
    {
  ...
  const tours = [
    {
      ...
      details: {
        day1:
          "Day 1: Hobart City Highlights, Richmond historic village, Salamanca Place, Battery Point, and panoramic views from Mount Wellington.",
        day2:
          "Day 2: Bruny Island gourmet experience with oysters, cheese tasting, Adventure Bay, The Neck Lookout, and stunning coastal scenery.",
        day3:
          "Day 3: Port Arthur Historic Site, Tasman Arch, Devil's Kitchen, Tessellated Pavement, and optional wilderness cruise.",
        day4:
          "Day 4: Freycinet National Park, Wineglass Bay Lookout, Honeymoon Bay, and Cape Tourville scenic walk.",
      },
    },
    {
        ...
        <div className="absolute inset-0 bg-black/40" />
          ...
          <div className="mb-6 space-y-3">
            <h1 className="text-5xl font-bold md:text-7xl">
              Discover Tasmania ｜ 探索塔斯馬尼亞
            </h1>
            <h2 className="text-3xl font-semibold md:text-5xl">
              Luxury Small Group Tours ｜ 精品高端小團旅行
            </h2>
          </div>
          <div className="mb-8 max-w-3xl space-y-3 text-lg md:text-2xl">
            <p>
              Premium small-group tours, unforgettable landscapes, and authentic Tasmanian experiences. ｜ 精品小團旅行、壯麗自然風景與最道地的塔州體驗。
            </p>
            <p>
              Private itineraries, local experiences, and stress-free Tasmania holidays. ｜ 私人訂製行程、在地體驗與輕鬆無憂的塔州假期。
            </p>
          </div>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          ...
          <div>
            ...
            <p className="mb-4 text-lg leading-relaxed text-gray-600">
              VentureMax Travel is one of Tasmania's local professional tour operators, providing local tour, food and accommodation experiences.
            </p>

            <p className="mb-4 text-lg leading-relaxed text-gray-600">
              We have a professional, enthusiastic, and reliable team with extensive tourism experience, allowing us to satisfy a wide range of guest needs.
            </p>

            <p className="mb-6 text-lg leading-relaxed text-gray-600">
              In addition to day tours and tour packages, we also provide tailored private tours based on individual requirements. Currently, the company operates 7-seat vehicles, 12 and 14-seat minibuses, and 25-seat coaches, enabling us to accommodate most group sizes comfortably.
            </p>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <a
                      href="/classic-hobart-tour"
                      className="inline-block rounded-xl bg-black px-5 py-3 text-white transition hover:opacity-90"
                    >
                      View Details
                    </a>
                  </div>
